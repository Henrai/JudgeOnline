...
<p>
	Difficulty Level:
	<select name='d_level' >
		<option value="N" <?php if($row->difficulty_level == "N") echo 'selected="selected"'?> >N</option>
		<option value="R" <?php if($row->difficulty_level == "R") echo 'selected="selected"'?> >R</option>
		<option value="SR" <?php if($row->difficulty_level == "SR") echo 'selected="selected"'?> >SR</option>
		<option value="SSR" <?php if($row->difficulty_level == "SSR") echo 'selected="selected"'?> >SSR</option>
		<option value="UR" <?php if($row->difficulty_level == "UR") echo 'selected="selected"'?> >UR</option>
	</select>
</p>
...
echo "Sample data file in $basedir Updated!<br>";
	...
	$d_level=mysqli_real_escape_string($mysqli,$d_level);
...
$sql="UPDATE `problem` set `title`='$title',`difficulty_level`='$d_level', `time_limit`='$time_limit',`memory_limit`='$memory_limit',
