...
$sql="select `problem_id`, `difficulty_level`, `title`,`in_date`,`defunct` FROM `problem` where problem_id>=$pstart and problem_id<=$pend order by `problem_id` desc";
//echo $sql;
...
echo "<tr><td>PID<td>Difficulty Level<td>Title<td>Date";
