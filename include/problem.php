...
function addproblem($title, $d_level, $time_limit, $memory_limit, $description, $input, $output, $sample_input, $sample_output, $hint, $source, $spj,$OJ_DATA) {
...
//	$spj=($spj);
	...
	$sql = "INSERT into `problem` (`title`, `difficulty_level`,`time_limit`,`memory_limit`,
	`description`,`input`,`output`,`sample_input`,`sample_output`,`hint`,`source`,`spj`,`in_date`,`defunct`)
	VALUES('$title', '$d_level', '$time_limit','$memory_limit','$description','$input','$output',
